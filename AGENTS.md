...
Use the release skill: see `.agents/skills/release/SKILL.md`.

Quick summary:
1. Update `CHANGELOG.md` with a dated `## [VERSION]` entry.
2. Run `./scripts/release.sh VERSION --publish`.
3. The script handles versioning, testing, signing, tagging, and pushing.
